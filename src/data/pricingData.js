// ─── SHARED PRICING DATA ────────────────────────────────────────
// Used by both HeroCalculator and PatchCalculator

export const SIZES = [2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7]
export const QTY_TIERS = [12, 25, 50, 100, 200, 300, 500, 1000, 2000, 3000, 5000]
export const BACKING_SIZES = [2.0, 2.5, 3.0, 3.5, 4.0, 4.5, 5.0]
...
// ─── PATCH CALCULATOR ONLY DATA ─────────────────────────────────
export const BLANK_SIZES = [2, 2.5, 3, 3.5, 4, 4.5, 5]
export const BLANK_QTY_TIERS = [100, 200, 300, 500, 1000, 2000]
...
// ─── HELPERS ────────────────────────────────────────────────────
export function getEmbPrice(coverage, size, qty) {
...
export function getBackingAddon(backing, size) {
...
export function getBlankPrice(size, qty) {
...
export function getBullionPrice(variant, qty) {
